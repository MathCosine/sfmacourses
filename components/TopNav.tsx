    ...
    <>
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center gap-1 px-4 sm:px-6">
          ...
          <nav className="ml-2 hidden items-center gap-0.5 lg:flex">
            ...
            <div ref={learnRef} className="relative">
              ...
              {learnOpen && (
                <div className="menu-pop glass absolute left-0 top-full mt-1.5 w-[320px] overflow-hidden rounded-2xl p-2">
          ...
          {user ? (
            <div ref={profileRef} className="relative hidden lg:block">
              ...
              {profileOpen && (
                <div className="menu-pop glass absolute right-0 top-full mt-1.5 w-60 overflow-hidden rounded-2xl py-1.5">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="glass absolute right-0 top-0 h-full w-[300px] overflow-y-auto rounded-none p-5">
