    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-[300px] overflow-y-auto bg-surface p-5 shadow-xl">
...
function SearchModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-start justify-center px-4 pt-[12vh]" onClick={onClose}>
      ...
      <div
        className="relative w-full max-w-xl overflow-hidden rounded-2xl border border-border bg-surface shadow-xl"
